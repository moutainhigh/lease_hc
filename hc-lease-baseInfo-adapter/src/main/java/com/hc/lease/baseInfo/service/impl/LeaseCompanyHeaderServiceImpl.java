...
public class LeaseCompanyHeaderServiceImpl implements LeaseCompanyHeaderService {
    ...
    public void updateSort(LeaseCompanyHeader leaseCompanyHeader) {

        Map<String, Object> paramsMap = Maps.newHashMap();
        paramsMap.put("id",leaseCompanyHeader.getId());
        paramsMap.put("mark",leaseCompanyHeader.getMark());
        leaseCompanyHeaderMapper.updateSort(paramsMap);

    }

    public Integer findMaxNumber() {
        Integer number= leaseCompanyHeaderMapper.findMaxNumber();
        return number;
    }

    public List<LeaseCompanyHeader> findAllNoPage(Map param) {
        List<LeaseCompanyHeader> leaseCompanyHeaderList = leaseCompanyHeaderMapper.findPage(param);
    ...
    public int disableByPrimaryKey(Map<String, Object> params) throws GMException {
        int row = leaseCompanyHeaderMapper.disableByPrimaryKey(params);
        return row;
    }
    ...
    public List<String> findExportExcelModel(Map params) throws GMException {
        List<String> list = leaseCompanyHeaderMapper.findExportExcelModel(params);
        return list;
    }
}
