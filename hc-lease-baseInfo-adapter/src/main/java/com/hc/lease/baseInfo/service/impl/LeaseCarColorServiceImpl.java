...
public class LeaseCarColorServiceImpl implements LeaseCarColorService {
    ...
    public int disableByPrimaryKey(Map<String, Object> params) throws GMException {
        int row = leaseCarColorMapper.disableByPrimaryKey(params);
        return row;
    }
    ...
    public List<String> findExportExcelModel(Map params) throws GMException {
        List<String> list = leaseCarColorMapper.findExportExcelModel(params);
        return list;
    }

    public void updateSort(LeaseCarColor leaseCarColor) {

        Map<String, Object> paramsMap = Maps.newHashMap();
        paramsMap.put("id",leaseCarColor.getId());
        paramsMap.put("mark",leaseCarColor.getMark());
        leaseCarColorMapper.updateSort(paramsMap);

    }

    public List<LeaseCarColor> findAllNoPage(Map param) {
        List<LeaseCarColor> leaseCarColorList= leaseCarColorMapper.findPage(param);
        return leaseCarColorList;
    }

    public Integer findMaxNumber() {
        Integer number=leaseCarColorMapper.findMaxNumber();
        return number;
    }
}
