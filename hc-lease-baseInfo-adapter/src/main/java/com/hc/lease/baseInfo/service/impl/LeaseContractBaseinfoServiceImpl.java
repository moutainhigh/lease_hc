...
public class LeaseContractBaseinfoServiceImpl implements LeaseContractBaseinfoService {
    ...
    public LeaseContractBaseinfo selectByPrimaryKey(Long id) throws GMException {
        ...
        Object contractPartyContactAddress = leaseContractBaseinfo.getContractPartyContactAddress();
        JSONArray array=JSONArray.fromObject(contractPartyContactAddress);
        List<ContractPartyContactAddressVo> list = JSONArray.toList(array, new ContractPartyContactAddressVo(), new JsonConfig());
        leaseContractBaseinfo.setContractPartyContactAddressVoList(list);
    ...
    public List<LeaseContractBaseinfo> findAllNoPage(Object o) {
        List<LeaseContractBaseinfo> list = leaseContractBaseinfoMapper.findAllNoPage(null);
        return list;
    }

    public int disableByPrimaryKey(Map<String, Object> params) throws GMException {
        int row = leaseContractBaseinfoMapper.disableByPrimaryKey(params);
        return row;
    }
