...
import com.hc.lease.baseInfo.service.api.LeaseMaintenancePartnerService;
...
public class LeaseMaintenancePartnerServiceImpl implements LeaseMaintenancePartnerService {
    ...
    public int disableByPrimaryKey(Map<String, Object> params) throws GMException {
        int row = leaseMaintenancePartnerMapper.disableByPrimaryKey(params);
        return row;
    }


    public void updateSort(LeaseMaintenancePartner leaseMaintenancePartner) {

        Map<String, Object> paramsMap = Maps.newHashMap();
        paramsMap.put("id",leaseMaintenancePartner.getId());
        paramsMap.put("mark",leaseMaintenancePartner.getMark());
        leaseMaintenancePartnerMapper.updateSort(paramsMap);
    }
    ...
    public List<LeaseMaintenancePartner> findAllNoPage(Map param) {
        List<LeaseMaintenancePartner> leaseMaintenancePartnerList=leaseMaintenancePartnerMapper.findPage(param);
        return leaseMaintenancePartnerList;
    }
