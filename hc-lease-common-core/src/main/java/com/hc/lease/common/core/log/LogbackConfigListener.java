package com.hc.lease.common.core.log;

import ch.qos.logback.classic.LoggerContext;
import ch.qos.logback.classic.joran.JoranConfigurator;
import ch.qos.logback.core.joran.spi.JoranException;
import hc.lease.common.util.PlaceHolderUtils;
import hc.lease.common.util.SystemPropertiesUtil;
...
public class LogbackConfigListener implements ServletContextListener {
    ...
    static {
        try {
            ...
            logger.info("初始化java.security.MessageDigest失败:", e);
        }
    }
    ...
    public void contextInitialized(final ServletContextEvent event) {
        ...
        String fn = null;
        try {
            fn = ResourceUtils.getFile(logbackConfigLocation).getPath();
        } catch (FileNotFoundException e) {
            throw new IllegalArgumentException("not found 'logback configure' :" + e.getMessage());
        }
        ...
        try {
            ...
            try {
                ...
                logger.info("parse " + CONFIG_REFRESH_INTERVAL + " failed. value " + strInterval + " is illegal." + e.getMessage(), e);
            }
            ...
            try {
                ...
                logger.info("parse " + REFRESH_SPRING_CONTEXT + " failed.value " + strRefreshCtx + " is illegal." + e.getMessage(), e);
            }
            ...
            timer.schedule(new TimerTask() {
                ...
                public void run() {
                    try {
                        ...
                        String logbackConfigLocation = servletContext.getInitParameter(CONFIG_LOCATION);
                        String newConfigMD5 = getMD5(logbackConfigLocation);
                        ...
                        if (!propMD5.equals(newPropMD5) || !configMD5.equals(newConfigMD5)) {
                            ...
                            // 如果开起刷新Spring context，并且properties文件已变更
                        ...
                        logger.info("reload config failed." + e.getMessage(), e);
                    }
                }
    ...
    private Properties getPropertiesParam(ServletContext servletContext) {
        ...
        try {
            ...
            configMD5 = getMD5(logbackConfigLocation);
