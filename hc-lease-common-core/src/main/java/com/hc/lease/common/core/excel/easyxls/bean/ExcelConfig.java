package com.hc.lease.common.core.excel.easyxls.bean;


import com.hc.lease.common.core.excel.easyxls.common.FieldUtil;
                    ...
                    if (name.indexOf(separater) > 0) {
                        ...
                        switch (ns.length) {
                            ...
                            case 4:
                                ...
                                break;
                            case 5:
                                addColumn(new Column(ns[0], ns[1], Integer.parseInt(ns[2]), ns[3], ns[4]));
                                break;
                        }
                    } else {
