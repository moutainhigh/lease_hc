...
public class LeaseScheme  implements Serializable {
   ...
   @ApiModelProperty(value = "品牌主键Id/适用车型", hidden = false)
    ...
    @ApiModelProperty(value = "滞纳金日利率", hidden = false)
   ...
   /* @ApiModelProperty(value = "省份ID", hidden = false)
    ...
    @ApiModelProperty(value = "融租方案尾款实体类", hidden = false, required = true)
    private List<LeasePackageBalancePayment> leasePackageBalancePayments;
    @ApiModelProperty(value = "融租方案尾款实体类Json", hidden = false, required = true)
