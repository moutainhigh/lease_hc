...
import com.allinpay.tool.security.CryptInf;
import com.allinpay.tool.security.CryptNoRestrict;
import com.allinpay.tool.security.CryptUnderRestrict;
...
public class XmlTools
{
	...
	public static void main(String[] args) throws Exception
	{
		...
		// 签名
		String signMsg=signPlain(orgs, "cer/allinpay-pds.pfx","allinpay-pds",null);
		System.out.println("签名信息:"+signMsg);
		// 验签
		CryptInf crypt;
		crypt=new CryptNoRestrict("GBK",null);
		boolean flag=crypt.VerifyMsg(signmsg, orgs, "cer/test/allinpay-pds.cer");
		if(flag){
