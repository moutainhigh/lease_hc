 ...
 * 贷后车辆管理-丢失
 */
public class LeaseContractCarLose implements Serializable {
    ...
    private Long carId;
    @ApiModelProperty(value = "丢失备注 (新增传值)", hidden = false)
    private String remarks;
    @ApiModelProperty(value = "处置方式 1丢失中 2找回续租 3找回断供（待转租/待转卖） 4丢失结束 5取消丢失", hidden = false)
