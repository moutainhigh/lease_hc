 ...
 */
public class ScrapFindByPrimaryKeyVo implements Serializable {
    ...
    private Long id;
    @ApiModelProperty(value = "报废备注", hidden = false)
    ...
    private String dealRemarks;@ApiModelProperty(value = "合同主键Id", hidden = false)
    ...
    public String toString() {
        return "ScrapFindByPrimaryKeyVo{" +
