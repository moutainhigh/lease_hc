...
public class LeaseAllinpayStatusLogServiceImpl implements LeaseAllinpayStatusLogService {
    ...
    public List<LeaseAllinpayStatusLog> selectByAllinpayLogId(Map<String, Object> paramsMap, DubboTreaceParames dubboTreaceParames) {
        List<LeaseAllinpayStatusLog> leaseAllinpayStatusLogList = leaseAllinpayStatusLogMapper.selectByAllinpayLogId(paramsMap);
        return leaseAllinpayStatusLogList;
    }
