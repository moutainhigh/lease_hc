 ...
 */
public interface LeaseAllinpayQueryLogMapper extends BaseDao<LeaseAllinpayQueryLog> {
     ...
     * @return
     */
    List<LeaseAllinpayQueryLog> selectByAllinpayLogId(Map<String, Object> paramsMap);
