...
public class Generate {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String serviceImpl_projectPath = "E:/luomingtong/work/project/hc_lease/hc-lease-baseInfo-adapter";
        String serviceApi_projectPath = "E:/luomingtong/work/project/hc_lease/hc-lease-baseInfo-adapter-api";
        ...
        String moduleName = "baseInfo";            // 模块名，例：sys
        String subModuleName = "";                // 子模块名（可选）
        String className = "LeaseCarBrands";            // 类名，例：user
        String classAuthor = "Tong";        // 类作者，例：ThinkGem
        String functionName = "车辆品牌";            // 功能名，例：用户

        dualFile(packageName, moduleName, subModuleName, className, classAuthor, functionName,serviceImpl_projectPath,serviceApi_projectPath);
        ...
        map.put("moduleName","");
        map.put("subModuleName","baseInfo");
        map.put("className","LeaseCarModel");
    ...
    public static void dualFile(String packageName, String moduleName, String subModuleName, String className, String classAuthor, String functionName,String serviceImpl_projectPath_c,String serviceApi_projectPath_c) throws Exception {
        ...
        File tplPath_projectPath = new File("E:/luomingtong/work/project/hc_lease/hc-lease-common-util");// 模板文件所在项目路径
