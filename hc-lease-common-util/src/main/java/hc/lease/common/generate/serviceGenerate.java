...
public class serviceGenerate {
    ...
    private static Logger logger = LoggerFactory.getLogger(serviceGenerate.class);
    ...
    public static void main(String[] args) throws Exception {
        ...
        String classAuthor = "tong";        // 类作者，例：tong
    ...
    public static void dualFile(String packageName, String moduleName, String subModuleName, String className, String classAuthor, String functionName, String serviceImpl_projectPath_c, String serviceApi_projectPath_c) throws Exception {
        ...
        */
        ...
        content = FreeMarkers.renderTemplate(template, model);
        filePath = serviceImpl_javaPath + separator + model.get("moduleName") + separator + "service" + separator + "impl" + separator
                + StringUtils.lowerCase(subModuleName) + separator + model.get("ClassName") + "ServiceImpl.java";
        writeFile(content, filePath);
        logger.info("Service: {}", filePath);

        // 生成 serviceApi
        template = cfg.getTemplate("serviceApi.ftl");
        content = FreeMarkers.renderTemplate(template, model);
        filePath = serviceApi_javaPath + separator + model.get("moduleName") + separator + "service" + separator + "api" + separator
